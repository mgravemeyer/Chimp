...
struct CommandLineRowView_Previews : PreviewProvider {
    static var contact = Contact(id: UUID().uuidString, firstname: "longTestUserFirstName", lastname: "longTestUserLastName", email: "longTestUserEmail@web.de", telephone: "123456789012", birthday: "33.33.3333", company: "longCompanyName")
