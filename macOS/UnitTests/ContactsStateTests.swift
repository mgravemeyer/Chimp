...
class ContactsStateTests: XCTestCase {
    ...
    func test_createContact() throws {
        ...
        let contact = Contact(firstname: "firstName", lastname: "lastName", email: "test@test.de", telephone: "016284392", birthday: "1577880831", company: "company")
    ...
    func test_getContactCategories() throws {
        let contactsState = ContactsState()
        let contact = Contact(firstname: "firstNameUI", lastname: "lastNameUI", email: "test@test.deUI", telephone: "016284392", birthday: "1577880831", company: "companyUI")
        contactsState.createContact(contact: contact)
